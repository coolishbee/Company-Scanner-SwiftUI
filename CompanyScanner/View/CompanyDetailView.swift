...
//                let job1 = Job(id: 0, title: "iOS 개발자", detail: "", responsibilities: "", requirements: "", preferred: "")
//                let job2 = Job(id: 1, title: "Android 개발자", detail: "", responsibilities: "", requirements: "", preferred: "")
//                NavigationLink(destination: JobDetailView(selectedJob: job1).navigationBarBackButtonHidden()) {
//                    JobListCell(job: job1)
//                }
//                NavigationLink(destination: JobDetailView(selectedJob: job2).navigationBarBackButtonHidden()) {
//                    JobListCell(job: job2)
//                }
            }
